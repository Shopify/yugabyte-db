...
YB_CLIENT_SPECIALIZE_SIMPLE_EX(Admin, CancelSchemaMigration);
YB_CLIENT_SPECIALIZE_SIMPLE_EX(Admin, CreateTransactionStatusTable);
YB_CLIENT_SPECIALIZE_SIMPLE_EX(Admin, GetSchemaMigration);
YB_CLIENT_SPECIALIZE_SIMPLE_EX(Admin, ListSchemaMigrations);
YB_CLIENT_SPECIALIZE_SIMPLE_EX(Admin, StartSchemaMigration);
